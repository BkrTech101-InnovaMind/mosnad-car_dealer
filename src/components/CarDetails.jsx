        ...
        <div className="px-10 py-6 max-lg:max-w-2xl">
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <button
                type="button"
                className="w-12 h-12 border-2 hover:border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0"
              >
                SM
              </button>
              <button
                type="button"
                className="w-12 h-12 border-2 hover:border-gray-800 border-gray-800 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0"
              >
                MD
              </button>
              <button
          ...
          <div className="mt-8">
            <div>
              ...
              <p className="text-sm text-gray-800 mt-4">
                ...
                perfect for everyday wear. Its classNameic crew neck and short
